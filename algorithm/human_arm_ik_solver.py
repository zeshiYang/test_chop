...
class HumanArm_IK_Solver(object):
    ...
    def compute_target_transformation(self, transformation):
        ...
        return convertfromglm2vec(pos_wrist), convert2array(q_wrist)
    ...
    def ik_first4(self, pos_elbow_ref, pos_wrist_ref):
        ...
        pos_wrist_init = pos_elbow_ref + convertfromglm2vec(q_temp * glm.quat(0, 0, 0.3, 0) * glm.inverse(q_temp))
    ...
    def ik_last3(self, q_wrist_ref, q_first4):
        ...
        dq = glm.inverse(q_temp) * convert2glm(q_wrist_ref)
    ...
    def ik_first3_fromlast4(self, q_wrist_ref, q_last4):
        ...
        dq = convert2glm(q_wrist_ref) * glm.inverse(q_temp)
    ...
    def ik(self, transformation, q_init = False):
        ...
        def f(x):
            ...
            dq = glm.inverse(convert2glm(transformation[3:])) * convert2glm(q_chopstick2) 
            if(dq[3]<0):
                dq= -dq
